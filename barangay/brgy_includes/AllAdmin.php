        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><button type="button" class="btn btn-sm btn-danger aDelete" data-post-id="<?php echo $adminID; ?>" data-bs-toggle="modal" data-bs-target="#deleteModal"><i class=" bi bi-trash"></i></button></td>
                </tr>
            <?php
            }
            ?>
