 <li class="nav-item">
     <button class="btn nav-link " aria-current="page" data-bs-toggle="modal" data-bs-target="#addAdmin">Add super admin account</button>
 </li>
         ...
         <div class="modal-content">
             <div class="modal-header">
                 <div class="w-100 text-center">
                     <h4 class="modal-title " id="addAdminLabel">Add Super Admin Account</h4>
                 </div>
