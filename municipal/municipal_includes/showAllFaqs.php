...
<div class="table-responsive ">
    <table class="table table-responsive table-bordered border border-3 table-hover text-center text-capitalized">
        <thead class="table-active text-uppercase text-white">
            <tr>
                <th class="text-light" style="background-color: #ee7ea0; width: 10%;"><small>Faq ID</small></th>
                <th class="text-light" style="background-color: #ffaf6e; width: 20%;"><small>Faq Question</small></th>
                <th class="text-light" style="background-color: #7d8be0; width: 40%;"><small>Faq Answer</small></th>
                <th class="text-light" style="background-color: #9a81b0; width: 20%;"><small>Faq Created At</small></th>
                <th class="text-light" style="background-color: #9a81b0; width: 10%;">Action</th>
            </tr>
        </thead>
        <tbody>
            <?php
