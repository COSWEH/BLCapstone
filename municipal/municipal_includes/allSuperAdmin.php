        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><button type="button" class="btn btn-sm btn-danger saDelete" data-post-id="<?php echo $superAdminID; ?>" data-bs-toggle="modal" data-bs-target="#deleteSAModal"><i class=" bi bi-trash"></i></button></td>
                </tr>
            <?php
            }
            ?>
